...
public:
    ...
    void mipmap(const GLint minify_filter = GL_NEAREST_MIPMAP_NEAREST,
                const GLint magnify_filter = GL_LINEAR) const;
    void wrap(const GLint wrap_s = GL_CLAMP_TO_EDGE,
              const GLint wrap_t = GL_CLAMP_TO_EDGE) const;
